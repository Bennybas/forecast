...
import AlgoCreationArea from './AlgoCreationArea';
import { useNavigate } from 'react-router-dom';

const ForecastAlgorithm = () => {
            ...
            <div className='flex justify-between items-center w-full'>
                ...
                <div className='flex gap-2'>
                    <div className='flex border border-teal-600 h-6 w-28 rounded-lg justify-center items-center cursor-pointer'>
                        <span className="font-medium text-teal-600">Save</span>
                    </div>
                    <div 
                    onClick={()=> navigate('/forecast-table')}
                    className='flex bg-teal-600 h-6 w-28 rounded-lg justify-center items-center cursor-pointer'>
                        <span className=' font-medium text-white'>Create Forecast</span>
                    </div>
                </div>
            </div>
        </div>
...
export default ForecastAlgorithm;